...
class EventAddBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  protected function blockAccess(AccountInterface $account) {
    ...
    assert($account instanceof UserInterface, "The user parameter should be automatically upcasted by Drupal, check the route configuration.");
    if ($account->id() == $route_user->id() && $account->hasPermission("create event content")) {
